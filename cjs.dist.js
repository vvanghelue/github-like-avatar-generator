(() => {
  ...
  // index.js
  var import_color_convert = __toModule(require_color_convert());
  function getRandomColor({ canBeBlank = true, dominantColor = null }) {
    ...
    return "#" + import_color_convert.default.hsl.hex(colorValue, 100, 80);
  }
